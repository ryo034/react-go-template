...
export const targetTables = [
  ...
  "system_account_latest_emails",
  "system_account_names",
  "system_account_latest_names",
  "system_account_phone_numbers",
  "system_account_latest_phone_numbers",
  "system_account_photo_events",
  "system_account_photos",
  "system_account_latest_photo_events",
  "workspaces",
  "workspace_details",
  "members",
  "member_roles",
