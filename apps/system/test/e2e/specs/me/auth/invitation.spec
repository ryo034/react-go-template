...
tags: stateful
* トークン"018e4922-563a-735c-a715-2fe940d327cf"の招待画面を開く
...
* "送信"ボタンをクリック
* 招待受諾画面でワークスペース"Invite TestHasEvent"招待者"Invite TestHasEvent"の参加ボタンをクリック
// 所属情報の確認
* 所属中の表示名が"Invitation Test"である
* 選択中のワークスペース名が"Invite TestHasEvent"である
